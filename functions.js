	...
	//edited
		function display(third){
			...
			if(third=="select"&& $("#company").val()=="select"&&$("#type").val()=="select")
			{
				document.getElementById("table").innerHTML="";
			}
		else if(third=="select")
		{
			display_company_cars();
		}
		else{
...
$("#add_car").click(function()  {
	   ...
	   if($('#company_1').val()!="other"&&$('#model_1').val()!="other"&&$('#type_1').val()!="other")
		...
		if($('#company_1').val()=="other"||$('#company_1').val()=="select")
		{
			
			if($('#company_name').val()=="")
				$validation=1;
		}
		else if($('#type_1').val()=="other"||$('#type_1').val()==""||$('#type_1').val()=="select")
		{
			if($('#car_type').val()=="")
				$validation=1;
		}
		
		else if($('#model_1').val()=="other"||$('#model_1').val()==""||$('#model_1').val()=="select")
		{
			if($('#car_model').val()=="")
				$validation=1;
		}
