    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Zoooom</a>
            </div>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Welcome To ZOooOM!</div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <ul class="list-inline social-buttons">
                            <li><a href="https://twitter.com/ganesh_tt?lang=en"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li><a href="https://www.facebook.com/teja.srinivasganesh"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li><a href="https://www.linkedin.com/in/tejatummuri/"><i class="fa fa-linkedin"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <h4>Priyanka</h4>
                        <ul class="list-inline social-buttons">
                            <li><a href="https://twitter.com/PChadalavada?lang=en"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li><a href="https://www.facebook.com/chadalavada.priyanka.5"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li><a href="https://www.linkedin.com/in/priyanka-chadalavada/"><i class="fa fa-linkedin"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <h4>Keerthi</h4>
                        <ul class="list-inline social-buttons">
                            <li><a href="https://twitter.com/narra_keerthi?lang=en"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li><a href="https://www.facebook.com/keerthi.narra.3"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li><a href="https://www.linkedin.com/in/keerthinarra/"><i class="fa fa-linkedin"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
