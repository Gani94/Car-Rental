...
<script  type="text/javascript" src="User_interface2.js"></script>
...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" id ="showCatalog" href="#services3">Catalog</a>
                    </li>
                    <li>
                        <a class="page-scroll" id ="showsignup" href="#services">Add</a>
                    </li>
                    <li>
                        <a class="page-scroll" id="showsignin" href="#services1">Modify</a>
                    </li>
                    <li>
                        <a class="page-scroll" id="showcheckin" href="#services2">Car Check-In</a>
                    </li>
					<li>
    ...
    <section id="services3" class="catalog">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Car Catalog</h2>
